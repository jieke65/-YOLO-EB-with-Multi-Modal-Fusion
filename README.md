...
## Usage
Please download the dataset, and decompress it at the root folder of this repository. The dataset can be found [here]([https://github.com/your-repository-link/dataset](https://github.com/suyixuan123s/Fire-Segmentation-Dataset)) (replace with actual URL).
## Environment
